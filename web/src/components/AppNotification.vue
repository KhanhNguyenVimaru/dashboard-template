  ...
  <transition name="slide-right">
    ...
    >
            ...
            >
              ...
              >
                <path
                  ...
                  d="M10 18a8 8 0 100-16 8 8 0 000
                     ...
                     1.414L8.586 10l-1.293 1.293a1
                     1 0 001.414 1.414L10 11.414l1.293
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M18 10A8 8 0 112 10a8 8 0
                     0116 0zM9 9a1 1 0 112 0v4a1 1
                     0 11-2 0V9zm1-4a1.5 1.5
                     0 100 3 1.5 1.5 0 000-3z"
                />
              </svg>
            </div>
          </slot>
      ...
      <div class="h-0.5 bg-gray-200">
        <div
          class="h-0.5 transition-all duration-100 bg-gradient-to-r from-emerald-400 to-emerald-500"
